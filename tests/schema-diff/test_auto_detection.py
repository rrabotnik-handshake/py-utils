...
from schema_diff.loader import _guess_kind, _sniff_json_kind, _sniff_sql_kind, KIND_DATA, KIND_JSONSCHEMA, KIND_SQL, KIND_DBT_MODEL, KIND_DBT_MANIFEST, KIND_SPARK
...
def test_guess_kind_by_extension(tmp_path):
    ...
    assert detected in [KIND_SPARK, KIND_DATA]  # Could be either based on content parsing
